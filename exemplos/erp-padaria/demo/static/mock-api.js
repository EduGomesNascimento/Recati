...
(() => {
  ...
  const STORAGE_KEY = "recati_padaria_mock_backend_v2";
  const VERSION = 1;
  const ACTIVE_STATUSES = new Set(["ABERTO", "EM_PREPARO", "PRONTO"]);
  ...
  const DEFAULT_CONFIG = {
    ...
    mobile_obs_rapidas: ["Alergico a gluten", "Sem cebola", "Sem acucar", "Pouco sal", "Bem passado"],
    mobile_mais_pedidos: [],
  ...
  function seed() {
    ...
    [["Queijo Extra",3.5],["Bacon Extra",5],["Molho Especial",2],["Ovo",2.5],["Chocolate",3]].forEach(([nome,preco]) => {
    ...
    [["Pao Frances",0.95,400,"../static/img/pao.svg","Padaria","Unidade"],["Pao de Queijo",2.5,180,"../static/img/pao_queijo.svg","Salgado","Unidade recheada"],["Croissant",7.5,60,"../static/img/croissant.svg","Salgado","Massa folhada"],["Bolo de Cenoura",22.5,20,"../static/img/bolo.svg","Doce","Fatia especial"],["Bolo de Chocolate",26,18,"../static/img/bolo_choco.svg","Doce","Fatia com cobertura"],["Sanduiche Natural",14.9,50,"../static/img/sanduiche.svg","Lanche","Pao integral"],["Cafe Coado",4.5,250,"../static/img/cafe.svg","Bebida","Copo 200ml"],["Capuccino",7.9,120,"../static/img/cafe.svg","Bebida","Copo 300ml"],["Suco de Laranja",8.5,90,"../static/img/suco.svg","Bebida","Copo 300ml"],["Misto Quente",11.5,90,"../static/img/misto.svg","Lanche","Pao de forma"],["Empada de Frango",9,80,"../static/img/empada.svg","Salgado","Unidade"],["Esfiha de Carne",7,100,"../static/img/esfiha.svg","Salgado","Unidade"]].forEach(([nome,preco,estoque,img,cat,desc]) => {
    ...
    for (let i=1;i<=30;i+=1) state.codigos.push({ id: nextId(state,"codigo"), codigo: `C-${String(i).padStart(3,"0")}`, ativo: true, em_uso: false, criado_em: created });
    ...
    mkComanda({ codigo: "C-001", status: "ABERTO", tipo: "RETIRADA", mesa: "1", obs: "Mesa 1", offset: 25, itens: [{ nome: "Misto Quente", qtd: 1, obs: "Sem tomate", adds: [["Queijo Extra",1]], desc: 1.5 }, { nome: "Cafe Coado", qtd: 2 }] });
    mkComanda({ codigo: "C-002", status: "ABERTO", tipo: "ENTREGA", mesa: "12", obs: "Rua Azul, 30", offset: 70, itens: [{ nome: "Sanduiche Natural", qtd: 2, adds: [["Bacon Extra",1]] }, { nome: "Suco de Laranja", qtd: 2, desc: 2 }], pay: [{ metodo: "PIX", valor: 15, ref: "PIX-FAKE-01" }] });
    mkComanda({ codigo: "C-003", status: "EM_PREPARO", tipo: "RETIRADA", mesa: "4", obs: "Mesa 4", offset: 120, itens: [{ nome: "Croissant", qtd: 3, adds: [["Chocolate",1]] }, { nome: "Capuccino", qtd: 2 }] });
    mkComanda({ codigo: "C-004", status: "PRONTO", tipo: "RETIRADA", mesa: "8", obs: "Retirada balcao", offset: 180, itens: [{ nome: "Empada de Frango", qtd: 2 }, { nome: "Cafe Coado", qtd: 2 }] });
    mkComanda({ codigo: "C-005", status: "ENTREGUE", tipo: "ENTREGA", mesa: "15", obs: "Condominio Sol", offset: 1440, itens: [{ nome: "Bolo de Cenoura", qtd: 1 }, { nome: "Suco de Laranja", qtd: 1 }], pay: [{ metodo: "CARTAO_CREDITO", valor: 31, ref: "NSU-9001", maq: "MAQ-01" }] });
    mkComanda({ codigo: "C-006", status: "ENTREGUE", tipo: "RETIRADA", mesa: "7", obs: "Mesa 7", offset: 1100, itens: [{ nome: "Pao de Queijo", qtd: 6 }, { nome: "Cafe Coado", qtd: 3 }], pay: [{ metodo: "DINHEIRO", valor: 20 }, { metodo: "PIX", valor: 8.5, ref: "PIX-FAKE-02" }] });
    mkComanda({ codigo: "C-007", status: "CANCELADO", tipo: "RETIRADA", mesa: "5", obs: "Cliente desistiu", offset: 540, itens: [{ nome: "Esfiha de Carne", qtd: 2 }] });
  ...
  async function request(path, options = {}) {
    ...
    if (url.pathname === "/config/erp") {
      ...
      if (method === "PATCH" || method === "PUT") {
        ...
        if (payload.finalizar_mobile_status != null) next.finalizar_mobile_status = payload.finalizar_mobile_status === "PRONTO" ? "PRONTO" : "EM_PREPARO";
        if (!next.permitir_status_pronto && next.finalizar_mobile_status === "PRONTO") next.finalizar_mobile_status = "EM_PREPARO";
