...
const el = {
  ...
  kpiFinalizada: document.getElementById("kpi-finalizada"),
  kpiCancelada: document.getElementById("kpi-cancelada"),
...
function renderKpis() {
  ...
  el.kpiFinalizada.textContent = String(byStatus.FINALIZADA || 0);
  el.kpiCancelada.textContent = String(byStatus.CANCELADO || 0);
}
