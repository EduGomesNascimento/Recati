...
- App **mobile** para anotacao de pedido:
  ...
  - observacoes rapidas por chips (ex.: `Ao ponto`)
  - desconto por item
...
- App **desktop (caixa)**:
  ...
  - aba **Itens do Caixa** para adicionar/remover itens direto na comanda selecionada
...
- Mobile: `http://127.0.0.1:8100/mobile`
- Caixa desktop: `http://127.0.0.1:8100/caixa`
- Docs API: `http://127.0.0.1:8100/docs`
...
- Execute `iniciar_churrascaria_app.bat`

Esse launcher sobe a API e abre o navegador no app mobile.

## Acesso em outros dispositivos

- O servidor sobe na porta `8100` com host `0.0.0.0`, permitindo acesso de outros aparelhos na mesma rede.
- Em outro dispositivo, acesse:
  - Mobile: `http://SEU_IP_LOCAL:8100/mobile`
  - Caixa: `http://SEU_IP_LOCAL:8100/caixa`
...
- 12 produtos de churrascaria com foco em:
  - `Buffet`
  - `Mini Espeto`
  - `Espeto Completo`
  - `Buffet Almoco`
